...
import { View, Text, ScrollView, Image, Modal, StyleSheet, TextInput,TouchableOpacity,ActivityIndicator } from 'react-native'
...
import { SET_USER_DETAILS, SET_AUTH_STATUS,SET_USER_ID,SET_USER_IMAGES,SET_USER_SLOTS } from '../../Reducers/types';
...
export default function ProfileDetailsModal(props) {
    ...
    function addWorkingHours()
    {
        ...
        {
            setLoader(true);
            AddSlot(props.userDetails.temp_id,openHours,closeHours,day,SlotCallback)
        }
        else
        {
                    ...
                    <ScrollView style={{marginTop:modalMargin}}>
                        <View style={styles.apmodalView}>
                            <View style={{alignItems: 'flex-end'}}>
                                <Icon name="close" size={24}  style={styles.primaryText} onPress={() => setModalVisible4Hours(!modalVisible4Hours)} />
                            </View>
                            <Text style={[styles.primaryText,{fontSize: 20, textAlign: 'center'}]}>Add Hours</Text>
                           
                                <View style={Internalstyles.formGroup}>
                                    <View style={Internalstyles.textLabelWrapper}>
                                        <Text style={[styles.primaryText, Internalstyles.textLabel]}>Week Day:</Text>
                                    </View>
                                    <View>
                                        <Picker 
                                        style={[{width: 150,},styles.inputText]} onValueChange={(itemValue, itemPosition) =>  setDay(itemValue)} 
                                        selectedValue={day}  >
                                ...
                                <View style={Internalstyles.formGroup}>
                                    <View style={[Internalstyles.textLabelWrapper]}>
                                        <Text 
                                            style={[styles.primaryText, Internalstyles.textLabel]}>Opening Hours:</Text>
                                    </View>
                                    
                                    <TouchableOpacity onPress={()=>{setopenHoursVisible(true)}}>
                                        
                                        <Text style={[{width: 150, paddingLeft:14, paddingVertical:15}, styles.inputText]}>
                                            { openHours}
                                        </Text>
                                        <DateTimePickerModal
                                            ...
                                            onCancel={()=>{setopenHoursVisible(false)}}
                                        />
                                    </TouchableOpacity>
                                </View>
                                ...
                                <View style={Internalstyles.formGroup}>
                                    <View style={Internalstyles.textLabelWrapper}>
                                        <Text style={[styles.primaryText, Internalstyles.textLabel]}>Closing Hours:</Text>
                                    </View>
                                    
                                    <TouchableOpacity onPress={()=>{setcloseHoursVisible(true)}}>
                                        <Text  style={[{width: 150, paddingLeft:14, paddingVertical:15},styles.inputText]}>
                                        ...
                                        <DateTimePickerModal
                                            ...
                                            onCancel={()=>{setcloseHoursVisible(false)}}
                                        />
                            ...
                            {showLoader?(<TouchableOpacity >
                                <View style={{backgroundColor: themeColors.PrimaryText, padding:10, marginTop:50, marginBottom:68, width:'80%', alignSelf: 'center', alignItems: 'center'}}>
                                    <ActivityIndicator size="small"  color={themeColors.primaryColor}/>
                                </View>
                            </TouchableOpacity>):
                            (<TouchableOpacity onPress={()=>addWorkingHours()}>

                                <View style={{backgroundColor: themeColors.PrimaryText, padding:10, marginTop:50, marginBottom:68, width:'80%', alignSelf: 'center', alignItems: 'center',borderRadius:5}}>
