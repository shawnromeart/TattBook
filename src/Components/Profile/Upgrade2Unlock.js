    ...
    return (
        <ScrollView>
            <View style={styles.container}>
                ...
                <Text style={[Internalstyles.h1, styles.primaryText]}>Upgrade To Unlock Profile</Text>
                ...
                <View style={Internalstyles.FormMainWrapper}>
                    <Text style={[styles.primaryText, Internalstyles.FormLabel]}>Enter Activation Code:</Text>
                    <View style={[styles.apmFormWrapper, Internalstyles.FormWrapper]}>
                        ...
                        <TouchableOpacity  onPress={() => action4ActivateBtn()}  style={[Internalstyles.activateBtnWrapper, styles.LinksAndIndicatorColor]}>
                            {loading?(
                                <ActivityIndicator size="large"/>
                            ):
                            (
                                <Text style={[Internalstyles.activateBtnText, styles.primaryText]} >Activate</Text>
                            )}
                        </TouchableOpacity>
                </View>
