...
export default function TabBar(props) {
    ...
    return (
        authStatus?(
        <View style={[{display:'flex',flexDirection: 'row',justifyContent: 'space-between', paddingBottom:15},styles.primaryBg]}>
            <View>
                {renderTabItem("home","Home",()=>props.navigation.navigate("Home"))}
            </View>
            <View>
                {renderTabItem("list","Appointments",()=>props.navigation.navigate("Appointment"))}
            </View>
            <View>
                {renderTabItem("dollar-sign","Deposits",()=>props.navigation.navigate("Deposit"))}
            </View>
            <View>
